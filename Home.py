...
<a class="menu-link" href="https://nouran-khallaf-free-txt-home-gdoog2.streamlit.app/?page=analysis" target="_self" style="float: left; color: #4a4a4a; text-align: center; padding: 14px 16px; text-decoration: none; font-size: 18px; margin: 0px; transition: 0.3s;onmouseover="this.style.color='#008CBA'" onmouseout="this.style.color='#4a4a4a'">
